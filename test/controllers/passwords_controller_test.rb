...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { body: @password.body, title: @password.title, user_id: @password.user_id } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { body: @password.body, title: @password.title, user_id: @password.user_id } }
